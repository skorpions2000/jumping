...
class ExampleViewer(RecycleView):
    ...
    def __init__(self, **kwargs):
        ...
        self.data = [{'text_login': str(x*999999999) + " Login",
                      'text_content': str(x*99999) + " Theme",
                      'text_detail': str(x*99999) + " "} for x in range(30)]
        print("test")
